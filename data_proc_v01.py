...
DEFAULT_COMPARISON_PROMPT = (
    ...
    "Your response should be formatted with clear, separate paragraphs. "
    "Begin with one or two concise paragraphs that analyze the reviews in a data-driven way—explain which company performs better and describe the key trend(s) driving this difference. "
    "Support your analysis with 1-2 brief, specific review examples (either paraphrased or quoted) that best illustrate this trend. "
    "Finally, on a new line and after an empty line, add a concluding paragraph that starts with a bold markdown header '**Key Takeaway:**' followed by one or two very specific, actionable insights for British Gas. "
    "Keep the language focused and avoid vagueness. "
    "Example:\n\n"
    "CheckATrade customers report faster response times than British Gas customers. Since independent contractors manage their own schedules, many can offer same-day or next-day service—especially for urgent boiler repairs. Reviews indicate that some CheckATrade engineers prioritize emergency cases more efficiently than a large organization can.\n\n"
    ...
    "**Key Takeaway:** British Gas should explore faster emergency response options, including same-day service slots for urgent cases and real-time tracking updates for customers waiting for an engineer."
)

DEFAULT_INSIGHTS_PROMPT = (
    "You are an expert competitor analyst writing for senior board members. "
    "Based on the review analysis provided, generate a list of the biggest and most important actionable business insights in a concise numbered list which British Gas can do better based on the differences you can learn from the difference in reviews. "
    "Only look for the big important ones and do not list any small ones which are not very data driven from the reviews or would not have much of an overall business impact. "
    "Support your analysis with 1-2 brief, specific review examples (either paraphrased or quoted) that best illustrate this trend. Anything which cannot be backed up by data should not be listed. "
    "Each insight should be brief and formatted as follows:\n\n"
    "1. **[Insight Title]:** [Short actionable recommendation].\n\n"
    "For example:\n\n"
    "1. **Faster Responses:** British Gas should explore faster emergency response options, including same-day service slots for urgent cases and real-time tracking updates for customers waiting for an engineer.\n\n"
    "Keep your language direct and focused, avoiding unnecessary details since these insights are for busy senior board members."
)
